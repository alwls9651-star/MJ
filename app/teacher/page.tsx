  ...
  try {
    ...
    return (
      <AppShell role="teacher">
        ...
        <Card className="mt-6 p-6"><div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center"><div><h2 className="text-xl font-extrabold">담당 강좌 신청자 명단</h2><p className="mt-2 text-sm text-slate-500">최신 신청 현황을 확인하고 Excel 명단을 내려받을 수 있습니다.</p></div><a href="/teacher/applications"><Button>신청자 보기</Button></a></div></Card>
      </AppShell>
    );
  } catch {
